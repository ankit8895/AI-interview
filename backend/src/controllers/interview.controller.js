...
export const analyzeResume = async (req, res) => {
  try {
    ...
    // handle binary data to make it accessable to pdfjs-dist lib
...
export const submitAnswer = async (req, res) => {
  try {
    ...
    // if user didn't submit answer within time
...
export const getInterviewScore = async (req, res) => {
  try {
...
export const getUserInterviewHistory = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ message: "current user interview found", interviews });
  } catch (error) {
    return res
      .status(500)
...
export const getInterviewReport = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: `failed to find current user interview report` });
  }
};
