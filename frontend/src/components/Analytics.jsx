...
const Analytics = ({ report }) => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-100 to-red-50 px-4 sm:px-6 lg:px-10 py-8">
              ...
              {questionWiseScore.map((q, i) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4">
                    ...
                    <div className="bg-red-100 text-red-600 px-3 py-1 rounded-full font-bold text-xs sm:text-sm w-fit">
                      {q.score ?? 0}/10
                    </div>
                  </div>

                  <div className="bg-red-50 border border-green-200 p-4 rounded-lg">
